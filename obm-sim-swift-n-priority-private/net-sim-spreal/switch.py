        ...
        if self.k>0:
            for ind,i in enumerate(self.buffer):
                if i[0] != -1:
                    ...
                    self.block_port[ind][1] = self.k*3000
...
################################################################################ BIT MAPPER ########################################################################################
        if self.per_port_buffer[outPort-1]== 0 and self.block_port[inPort-1][0] == 0:
...
################################################################################ BIT MAPPER ########################################################################################
        ...
        elif self.total_buffer_size > self.total_usage and self.block_port[inPort-1][0] == 0:
