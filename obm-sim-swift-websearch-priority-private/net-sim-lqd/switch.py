...
class Switch:
    ...
    def __init__(self, addr, num_tor_ports, num_agg_ports, hosts_per_rack,l):
        ...
        self.per_port_max_qsize = 3  if l!='0.3' else 2 # in terms of number of 1500B packets
    ...
    def allct(self, mem, currTimeslot):
        ...
        for i in self.buffer:
            if i[1]!=-1:
                self.packet_history[i[0].switch_uid][4] = 1
