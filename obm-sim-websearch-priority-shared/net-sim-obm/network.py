...
class Network:
    ...
    def run(self, flowtrace, endTimeslot, flowLogFile,wkld):
        """Run the network"""
        self.addLinks()
        ...
        while currTimeslot < endTimeslot:
            ...
            for h in self.hosts:
                counts_delta, events = self.hosts[h].runHost(currTimeslot, flowLogFile, ackQueues, totalPktSent, totalPktRecvd, totalFlowsFinished,wkld)
