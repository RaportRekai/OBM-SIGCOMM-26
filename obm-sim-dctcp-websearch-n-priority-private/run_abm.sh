...
cd net-sim-abm
python3 network.py 144-host-2-tier-fattree.json "workloads/websearch-trace-100G-load-0.3.csv.processed" 0.3 1000000 0.5
cd ..
mkdir -p "$NEW_FOLDER"
...
cd net-sim-abm
python3 network.py 144-host-2-tier-fattree.json "workloads/websearch-trace-100G-load-0.6.csv.processed" 0.6 1000000 1
cd ..
mkdir -p "$NEW_FOLDER"
...
cd net-sim-abm
python3 network.py 144-host-2-tier-fattree.json "workloads/websearch-trace-100G-load-0.9.csv.processed" 0.9 1000000 0.5
cd ..
mkdir -p "$NEW_FOLDER"
