...
cd net-sim-credence
python3 network.py 144-host-2-tier-fattree.json "workloads/websearch-trace-100G-load-0.6.csv.processed" 0.6 200000
cd ..
mkdir -p "$NEW_FOLDER"
...
cd net-sim-credence
python3 network.py 144-host-2-tier-fattree.json "workloads/websearch-trace-100G-load-0.9.csv.processed" 0.9 200000
cd ..
mkdir -p "$NEW_FOLDER"
