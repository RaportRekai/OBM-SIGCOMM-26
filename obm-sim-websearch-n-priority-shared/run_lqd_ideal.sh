...
# mkdir -p "$NEW_FOLDER"
# cd ..
# echo workloads/incast-trace-100G-degree-0.2.csv.processed >> stats_lqd-ideal.txt
# python3 stats.py lqd-ideal 0.2
# python3 stats.py lqd-ideal 0.2 >> stats_lqd-ideal.txt
...
# mkdir -p "$NEW_FOLDER"
# cd ..
# echo workloads/incast-trace-100G-degree-0.4.csv.processed >> stats_lqd-ideal.txt
# python3 stats.py lqd-ideal 0.4
# python3 stats.py lqd-ideal 0.4 >> stats_lqd-ideal.txt
...
# mkdir -p "$NEW_FOLDER"
# cd ..
# echo workloads/incast-trace-100G-degree-0.6.csv.processed >> stats_lqd-ideal.txt
# python3 stats.py lqd-ideal 0.62
# python3 stats.py lqd-ideal 0.62 >> stats_lqd-ideal.txt
...
# mkdir -p "$NEW_FOLDER"
# cd ..
# echo workloads/incast-trace-100G-degree-0.8.csv.processed >> stats_lqd-ideal.txt
# python3 stats.py lqd-ideal 0.8
# python3 stats.py lqd-ideal 0.8 >> stats_lqd-ideal.txt
