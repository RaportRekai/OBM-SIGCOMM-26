...
class Network:
    ...
    def __init__(self, netJsonFilepath,ld):
        ...
        self.switches = self.parseswitches(netJson["switches"],ld)
        ...
        self.drops = self.parseswitches(netJson["switches"],ld)
        netJsonFile.close()


    def parseswitches(self, switchParams,ld):
        """Parse switches from switchParams dict"""
        switches = {}
        for addr in switchParams:
            switches[addr] = Switch(addr, self.num_tor_ports, self.num_agg_ports, self.hosts_per_rack,ld)
        return switches
        ...
        while currTimeslot < endTimeslot:
            ...
            if eof and count == len(self.hosts):
                ...
                with open("reordering_abm_per_flow.txt", "a", encoding="utf-8") as f:
                    ...
                    f.write("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n")
                # with open("reordering_abm.txt", "a", encoding="utf-8") as f:
