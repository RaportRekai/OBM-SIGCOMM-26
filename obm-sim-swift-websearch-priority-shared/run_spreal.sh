...
cd net-sim-spreal
python3 network.py 144-host-2-tier-fattree.json "workloads/websearch-trace-100G-load-0.3.csv.processed" 0.3 10000000
mkdir -p "$NEW_FOLDER"
cd ..
...
cd net-sim-spreal
python3 network.py 144-host-2-tier-fattree.json "workloads/websearch-trace-100G-load-0.6.csv.processed" 0.6 10000000
mkdir -p "$NEW_FOLDER"
cd ..
...
cd net-sim-spreal
python3 network.py 144-host-2-tier-fattree.json "workloads/websearch-trace-100G-load-0.9.csv.processed" 0.9 10000000
mkdir -p "$NEW_FOLDER"
cd ..
