#!/bin/bash
BASE_DIR="/home/dan/obm-sim/obm-sim/net-sim-spreal"
...
# Incast
cd net-sim-spreal
python3 network.py 144-host-2-tier-fattree.json "workloads/incast-trace-100G-degree-0.2.csv.processed" 0.2 30000
mkdir -p "$NEW_FOLDER"
cd ..
echo workloads/incast-trace-100G-degree-0.2.csv.processed >> stats_spreal.txt
python3 stats.py spreal 0.2
python3 stats.py spreal 0.2 >> stats_spreal.txt
mv "$LOG_DIR/recvd-flows-0.2.txt" "$NEW_FOLDER/"
cp "$SWITCH_FILE" "$NEW_FOLDER/"

cd net-sim-spreal
python3 network.py 144-host-2-tier-fattree.json "workloads/incast-trace-100G-degree-0.4.csv.processed" 0.4 30000
mkdir -p "$NEW_FOLDER"
cd ..
echo workloads/incast-trace-100G-degree-0.4.csv.processed >> stats_spreal.txt
python3 stats.py spreal 0.4
python3 stats.py spreal 0.4 >> stats_spreal.txt
mv "$LOG_DIR/recvd-flows-0.4.txt" "$NEW_FOLDER/"
cp "$SWITCH_FILE" "$NEW_FOLDER/"

cd net-sim-spreal
python3 network.py 144-host-2-tier-fattree.json "workloads/incast-trace-100G-degree-0.6.csv.processed" 0.62 30000
mkdir -p "$NEW_FOLDER"
cd ..
echo workloads/incast-trace-100G-degree-0.6.csv.processed >> stats_spreal.txt
python3 stats.py spreal 0.62
python3 stats.py spreal 0.62 >> stats_spreal.txt
mv "$LOG_DIR/recvd-flows-0.62.txt" "$NEW_FOLDER/"
cp "$SWITCH_FILE" "$NEW_FOLDER/"

cd net-sim-spreal
python3 network.py 144-host-2-tier-fattree.json "workloads/incast-trace-100G-degree-0.8.csv.processed" 0.8 30000
mkdir -p "$NEW_FOLDER"
cd ..
echo workloads/incast-trace-100G-degree-0.8.csv.processed >> stats_spreal.txt
python3 stats.py spreal 0.8
python3 stats.py spreal 0.8 >> stats_spreal.txt
