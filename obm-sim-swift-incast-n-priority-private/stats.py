...
#path = f'net-sim-{algo}/prev_logs/all_logs/run_3/recvd-flows-{wkld}.txt'
# Helpers
...
r = 4
if float(wkld) == 0.3  and algo == "abm":
    r = 0
...
def print_tput_stats(name, arr):
    ...
    sys.stdout.write(f"Average recv throughput ({name}): {round((avg/10),r)*10} Gbps\n")
