...
class Switch():
    ...
    def __init__(self, load, addr, num_tor_ports, num_agg_ports, hosts_per_rack):
        ...
        self.per_port_max_qsize = 4 if load == "0.2" else 3  # in terms of number of 1500B packets
        ...
        self.sent = 0
        self.alpha_set = [[0.8,0.6,0.2],[0.8,0.6,0.2]]#[[1,0.5,0.2],[2,1,0.5]]#[[7,1,5],[2,1,0.5]]#[[0.8,0.6,0.4],[10,8,6],[18,14,10]]
