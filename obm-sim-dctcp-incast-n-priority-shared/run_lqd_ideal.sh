...
# mkdir -p "$NEW_FOLDER"
# cd ..
# echo workloads/websearch-trace-100G-load-0.3.csv.processed >> stats_lqd-ideal.txt
# python3 stats.py lqd-ideal 0.3
# python3 stats.py lqd-ideal 0.3 >> stats_lqd-ideal.txt
...
# mkdir -p "$NEW_FOLDER"
# cd ..
# echo workloads/websearch-trace-100G-load-0.6.csv.processed >> stats_lqd-ideal.txt
# python3 stats.py lqd-ideal 0.6
# python3 stats.py lqd-ideal 0.6 >> stats_lqd-ideal.txt
...
# mkdir -p "$NEW_FOLDER"
# cd ..
# echo workloads/websearch-trace-100G-load-0.9.csv.processed >> stats_lqd-ideal.txt
# python3 stats.py lqd-ideal 0.9
# python3 stats.py lqd-ideal 0.9 >> stats_lqd-ideal.txt
