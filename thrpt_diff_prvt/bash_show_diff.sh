...
for i in ${!incast_set[@]}; do
    /bin/python 'LQD/master/two_phase_workload_8_show_diff.py' 50 $incast_value $round_values ${incast_set[$i]}
...
for i in ${!incast_set[@]}; do
    ...
    taskset -c $((6*i+3)) /bin/python 'LQD/algo_spideal.py' 50 $incast_value $round_values ${incast_set[$i]} | tee  LQD/master/spideal_logs/output_spideal_50_${incast_value}_${round_values}_incast_set${incast_set[$i]}.txt &
    taskset -c $((6*i+4)) /bin/python 'LQD/algo_obm_bufferdrop.py' 50 $incast_value $round_values ${incast_set[$i]} | tee  LQD/master/obm_logs/output_obm_50_${incast_value}_${round_values}_incast_set${incast_set[$i]}.txt &
    ...
    taskset -c $((6*i+5)) /bin/python 'LQD/algo_optimal_attmpt.py' 50 $incast_value $round_values ${incast_set[$i]} | tee  LQD/master/optimal_logs/output_optimal_50_${incast_value}_${round_values}_incast_set${incast_set[$i]}.txt &
